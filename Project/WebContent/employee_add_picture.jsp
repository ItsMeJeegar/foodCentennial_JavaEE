...
<br>Item added to database<br>Add a picture for the item <%=itemName%>
</div>
...
<input type="submit" name="itemAction" value="Add Picture" style="margin: auto; background-color: #d4df38; border: 1px solid black; margin-top: 20px; height: 40px; width: 150px; margin-left: 	425px; font-size: 16px;">
</form>
</div>
